...
<br>
<div id="main_heading">Add Cuisine</div>
  <div class="form_outer">
  <form name="supcatform" method="post" action="__APP__/Menus/add_Cuisine">
  <table width="500" border="0" cellpadding="4" cellspacing="0">
   <tr>
  <td><strong>Cuisine Name:</strong><br />
  
    <input name="menu_name" type="text" id="menu_name" size="50" value="<?php echo ($info['cuisine_name']); ?>"></td>
  </tr>
   <tr>
  <td><strong>Cuisine Name2:</strong><br />
  
    <input name="menu_name2" type="text" id="menu_name2" size="50" value="<?php echo ($info['cuisine_name2']); ?>"></td>
  </tr>
  <tr>
  ...
  <td><strong>Cuisine Description:</strong><br>
  ...
  <input type="hidden" name="restaurant_id" id="restaurant_id"  value="<?php echo ($restaurant_id); ?>"/></td>
  </tr>
  </table>
  </form>
</div>
