...
<link href="css/facebox.css" media="screen" rel="stylesheet" type="text/css"/>
 ...
 <div style="padding-bottom:10px;text-align:center">
   ...
   <div id="navigation">
    ...
    <!-- <div class="links "><a href="?mod=customer" class="">Customers(0)</a></div> -->
...
<div id="AdminLeftConlum">
        ...
        <table width="100%" border="0" cellpadding="4" cellspacing="0">
            <tr align="left" valign="top">
                ...
                <td width="1052"><strong>Restaurant Name</strong><br />
                    <textarea name="catname" cols="35" id="catname" style="font-size:18px; font-family:Arial;">                    </textarea></td>
            </tr>
                        <!-- <tr align="left" valign="top"> 
                <td width="76"></td>
            ...
            <tr align="left" valign="top"> 
                ...
                <td><strong>Email:</strong><br />
                    <input name="email" type="text" size="40"  id="email" /> </td>
            </tr>
            <!--<tr align="left" valign="top"> 
              <td width="76"></td>
            ...
            <tr align="left" valign="top"> 
                ...
                <td><strong>Phone:</strong><br />
                    <input name="phone" type="text" size="40"  id="phone" /> </td>
            </tr>
            <tr align="left" valign="top"> 
                <td width="76"></td>
                <td><strong>Fax:</strong><br />
                    <input name="fax" type="text" size="40"  id="fax" /> </td>
            </tr>
 ...
 <tr align="left" valign="top">
                ...
                <td><strong>Resturant Address:</strong><br />
                    <input name="rest_address" type="text" size="40" id="rest_address" >            
                </td>
            </tr>
            <tr align="left" valign="top"> 
                <td></td>
                <td><strong>Resturant City:</strong><br />
                    <input name="rest_city" type="text" size="40" id="rest_city" >            
                </td>
            </tr>
            <tr align="left" valign="top"> 
                <td></td>
                <td><strong><span id="spnSP">Resturant State:</span></strong><br />
                    <input name="rest_state" type="text" size="40" id="rest_state">            
                </td>
            </tr>
            <tr align="left" valign="top"> 
                <td></td>
                <td><strong><span id="spnZP">Resturant Zip Code:</span></strong><br />
                    <input name="rest_zip" type="text" size="40" id="rest_zip" >            
                </td>
            </tr>
            <!-- <tr align="left" valign="top"> 
                <td></td>
            ...
            <tr align="left" valign="top" id="delivery_radius" > 
                ...
                <td><strong>Delivery Radius for Resturant:</strong><br />
                    <input name="delivery_radius" type="text" size="40" id="delivery_radius" >&nbsp;(miles)            </td>
            </tr>
           ...
           <!--  <tr align="left" valign="top">
            ...
            <tr align="left" valign="top">
                ...
                <td><strong>Order Minimum:</strong><br />
                    <input name="order_minimum" type="text" size="40" id="order_minimum" >            </td>
            </tr>
            <tr align="left" valign="top"> 
                <td></td>
                <td><strong>Sales tax % for Restaurant:</strong><br />
                    <input name="tax_percent" type="text" size="40" id="tax_percent" >            </td>
            </tr>
            <tr align="left" valign="top"> 
                <td></td>
                <td><strong>Delivery Charges:</strong><br />
                    <input name="delivery_charges" type="text" size="40" id="delivery_charges" >            </td>
            </tr> 
            <tr align="left" valign="top"> 
                <td></td>
                <td><strong>Announcements:</strong><br />
                    <input name="rest_announcements" type="text" size="40" id="rest_announcements" >            </td>
            </tr>
            <tr align="left" valign="top"> 
                <td></td>
                <td><strong>Announcement status:</strong><br />
                    <input name="announce_status" type="radio" value="1"  id="announce_status" checked>Activate            &nbsp;&nbsp;
                    <input name="announce_status" type="radio" value="0"  id="announce_status" >Deactivate
                </td>
            </tr>  
            <!-- <tr align="left" valign="top"> 
                <td></td>
            ...
            <tr align="left" valign="top"> 
                ...
                <td><strong>Resturant Status:</strong><br />
                    <input name="rest_open_close" type="radio" value="1"  id="rest_open_close"checked>Open            &nbsp;&nbsp;
                    <input name="rest_open_close" type="radio" value="0"  id="rest_open_close" >Close
                </td>
            </tr>
            ...
            <tr align="left" valign="top"> 
                <td>&nbsp;</td>
                <td>Facebook Link<br /><input name="facebookLink" type="text" size="40" id="facebookLink" /></td>
            </tr>
            <tr align="left" valign="top">
                <td width="76">&nbsp;</td>
                <td width="1052"><strong>META Keywords</strong><br />
                    <textarea name="meta_keywords" cols="35" id="meta_keywords" style="font-size:18px; font-family:Arial;">                   </textarea></td>
            </tr>
            <tr align="left" valign="top">
                <td width="76">&nbsp;</td>
                <td width="1052"><strong>META Description</strong><br />
                    <textarea name="meta_description" cols="35" id="meta_description" style="font-size:18px; font-family:Arial;">                    </textarea></td>
            </tr>
            <tr align="left" valign="top">
                <td>&nbsp;</td>
                <td>
...
<div id="AdminRightConlum" style="padding:5px; min-height:800px">
    <iframe src="__APP__/RestaurantDetails/openDate" frameborder="0"  width="100%" scrolling="no" id="iframe1" onload="calcHeight('iframe1')" height="570"></iframe>
</div>
<br class="clearfloat" />
</div>
<!--End body Div-->	
